    ...
    public static String fakeReview(String fileName){
        ...
        for (int i = 0; i <= temp.length() - 1; i++){
            ...
            if (temp.charAt(i) == '*' ){
                ...
                i = 0;
                if (Review.sentimentVal(temp.substring(i, temp.indexOf(" "))) < 0){
                    result += temp.substring(0,i) + Review.randomNegativeAdj();
                } else { 
                    result += temp.substring(0,i) + Review.randomPositiveAdj();
                }
